...
extension PreviewProvider {
    static var dev: PreviewData {
        return PreviewData.instance
    }
}
...
class PreviewData {
    ...
    let stat1 = Statistic(title: "Market Cap", value: "$12.5B", percentageChange: 25.34)
    let stat2 = Statistic(title: "Portfolio Value", value: "$19.5B", percentageChange: -2.8)
    let stat3 = Statistic(title: "Total Volume", value: "$1.32T")
